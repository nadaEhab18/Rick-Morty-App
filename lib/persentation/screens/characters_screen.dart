...
import 'package:rick_and_morty_bloc/persentation/widgets/character_item.dart';
  ...
  Widget _buildSearchedField() {
    return TextField(
      ...
      onChanged: (searchedCharacter) {
        addSearchedCharacterFotItemsToSearchedList(searchedCharacter);
      },
    );
  }

  void addSearchedCharacterFotItemsToSearchedList(String searchedCharacter) {
    ...
    return Center(
      child: Container(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 20,),
            Text('can\t Connect ... Check internet',
            style: TextStyle(
              fontSize: 22,
              color: MyColors.myGery,
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: _isSearching ? _buildSearchedField() : _buildAppBerTitle(),
